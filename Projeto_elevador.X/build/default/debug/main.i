...
void controle()
{
    ...
    int count = 0;
    int a = 52;
    int max_dutyValue = 1023;
    int min_dutyValue = 256;
    int destiny = distancia*60;
...
void col_down()
    {
        while(and_ating!=max_origem_down)
        {
            distancia = abs(and_ating-max_origem_down);
            if(and_ating>max_origem_down)
            {
                LATAbits.LATA2 = 0;
            }
            if(and_ating<max_origem_down)
